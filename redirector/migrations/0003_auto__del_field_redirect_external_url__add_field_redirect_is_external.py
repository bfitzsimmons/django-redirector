...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Redirect.external_url'
        db.delete_column('redirector_redirect', 'external_url')

        # Adding field 'Redirect.is_external'
        db.add_column('redirector_redirect', 'is_external',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Redirect.external_url'
        db.add_column('redirector_redirect', 'external_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Redirect.is_external'
        db.delete_column('redirector_redirect', 'is_external')
