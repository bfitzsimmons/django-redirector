...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Redirect', fields ['url']
        db.create_index('redirector_redirect', ['url'])


    def backwards(self, orm):
        # Removing index on 'Redirect', fields ['url']
        db.delete_index('redirector_redirect', ['url'])


    models = {
        'redirector.redirect': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'unique_together': "(('site', 'url'),)", 'object_name': 'Redirect'},
